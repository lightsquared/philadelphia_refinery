...
\item
  Some background (on models and observations) and underlying theory
  (check for 2-3 papers with assistants and teachers if needed)
\item
  Present equations if needed (Latex)
\end{itemize}

\hypertarget{notebook-imports}{%
\subsubsection{Notebook Imports}\label{notebook-imports}}

\begin{lstlisting}[language={},postbreak={},numbers=none,xrightmargin=7pt,belowskip=5pt,aboveskip=5pt,breakindent=0pt]
/Users/skmcneill/anaconda3/envs/philadelphia_refinery/lib/python3.7/site-packages/plotly/graph_objs/_deprecations.py:558: DeprecationWarning:
...
/Users/skmcneill/anaconda3/envs/philadelphia_refinery/lib/python3.7/site-packages/plotly/graph_objs/_deprecations.py:531: DeprecationWarning:
...
\subsection{Cleanup Data}\label{cleanup-data}}
...
\subsection{Analysis/Modeling}\label{analysismodeling}}
